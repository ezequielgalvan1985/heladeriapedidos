...
public class Pote {
    ...
    private ArrayList <ItemPote> itemsPote; // es el helado que va a estar en el pote
    ...
    public ArrayList<ItemPote> getItemsPote() {
        return itemsPote;
    }

    public void setItemsPote(ArrayList<ItemPote> itemsPote) {
